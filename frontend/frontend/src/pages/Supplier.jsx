            ...
            {suppliers.length === 0 ? (
              ...
              suppliers.map((supplier, index) => (
                <tr key={supplier.id || index} className="hover:bg-gray-50">
                  <td className="py-2 px-4 border-b"><nav className="rounded-md bg-green-600 px-3 py-1 text-sm text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500"><Link to={`/vendor/${supplier.id}`} >Edit</Link></nav></td>
